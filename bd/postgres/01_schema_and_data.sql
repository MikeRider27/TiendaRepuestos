-- =====================================================================
-- TiendaRepuestos - esquema y datos convertidos de MySQL/MariaDB a PostgreSQL
-- Generado a partir de bd/irresistibles.sql
-- =====================================================================
...
CREATE TABLE comprobantecompra (
  idComprobanteCompra integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE comprobanteventa (
  idComprobanteVenta integer GENERATED BY DEFAULT AS IDENTITY,
  numero varchar(15) NOT NULL,
  fecha timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  descripcion varchar(150) DEFAULT NULL,
  importe numeric(7,2) DEFAULT NULL,
  estado boolean NOT NULL DEFAULT true,
  idTipoComprobanteVenta integer NOT NULL
);
...
(1, 'F-001-000001', '2016-08-05 05:00:00', 'Realizando Ventas', '400.00', true, 2),
(2, 'B-001-000001', '2016-09-05 05:00:00', 'Realizando Ventas', '240.00', true, 1),
(3, 'F-001-000002', '2016-05-10 05:00:00', 'Realizando Ventas', '240.00', true, 2),
(4, 'B-001-000002', '2016-05-11 05:00:00', 'Realizando Ventas', '80.00', true, 1),
(5, 'F-001-000003', '2016-05-12 05:00:00', 'Realizando Ventas', '200.00', true, 2),
(6, 'B-001-000003', '2016-05-13 05:00:00', 'Realizando Ventas', '880.00', true, 1),
(7, 'F-001-000004', '2016-05-14 05:00:00', 'Realizando Ventas', '840.00', true, 2),
(8, 'B-001-000004', '2016-05-15 05:00:00', 'Realizando Ventas', '160.00', true, 1),
(9, 'F-001-000005', '2016-05-16 05:00:00', 'Realizando Ventas', '440.00', true, 2),
(10, 'B-001-000005', '2016-05-17 05:00:00', 'Realizando Ventas', '1300.00', true, 1),
(11, 'F-001-000006', '2016-05-18 05:00:00', 'Realizando Ventas', '1240.00', false, 2),
(12, 'B-001-000006', '2016-05-19 05:00:00', 'Realizando Ventas', '2500.00', true, 1),
(13, 'F-001-000007', '2016-05-20 05:00:00', 'Realizando Ventas', '1400.00', true, 2),
(14, 'B-001-000007', '2016-05-21 05:00:00', 'Realizando Ventas', '1280.00', true, 1),
(15, 'F-001-000008', '2016-05-22 05:00:00', 'Realizando Ventas', '1400.00', true, 2),
(16, 'B-001-000008', '2016-05-23 05:00:00', 'Realizando Ventas', '60.00', true, 1),
(17, 'F-001-000009', '2016-05-24 05:00:00', 'Realizando Ventas', '40.00', true, 2),
(18, 'B-001-000009', '2016-05-25 05:00:00', 'Realizando Ventas', '160.00', true, 1),
(19, 'F-001-000010', '2016-05-26 05:00:00', 'Realizando Ventas', '1180.00', true, 2),
(20, 'B-001-000010', '2016-05-27 05:00:00', 'Realizando Ventas', '1140.00', false, 1),
(21, 'F-001-000011', '2016-05-08 05:00:00', 'Realizando Ventas', '2000.00', true, 2),
(22, 'B-001-000011', '2016-05-29 05:00:00', 'Realizando Ventas', '1240.00', true, 1),
(23, 'F-001-000012', '2016-05-30 05:00:00', 'Realizando Ventas', '1240.00', false, 2),
(24, 'B-001-000012', '2016-05-31 05:00:00', 'Realizando Ventas', '2320.00', true, 1),
(25, 'F-001-000013', '2016-06-01 05:00:00', 'Realizando Ventas', '1320.00', false, 2),
(26, 'B-001-000013', '2016-10-28 05:00:00', '', '151.16', true, 1);
...
CREATE TABLE detallecompra (
  ...
  MontoTotal numeric(8,2) NOT NULL,
  idComprobanteCompra integer NOT NULL,
...
CREATE TABLE detalleoperacion (
  idDetalleOperacion integer GENERATED BY DEFAULT AS IDENTITY,
  cantidad integer NOT NULL,
...
CREATE TABLE detallepermiso (
  idDetallePermiso integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE detalleventa (
  idDetalleVenta integer GENERATED BY DEFAULT AS IDENTITY,
  idComprobanteVenta integer NOT NULL,
  idDetalleOperacion integer NOT NULL
);
...
CREATE TABLE kardex (
  idKardex integer GENERATED BY DEFAULT AS IDENTITY,
  detalle varchar(250) DEFAULT NULL,
  cantidadIngreso integer DEFAULT NULL,
  precioIngreso numeric(6,2) DEFAULT NULL,
  cantidadSalida integer DEFAULT NULL,
  precioSalida numeric(6,2) DEFAULT NULL,
  idRepuesto integer NOT NULL
);
...
CREATE TABLE login (
  idLogin integer GENERATED BY DEFAULT AS IDENTITY,
  idPersona integer NOT NULL,
...
CREATE TABLE operacion (
  idOperacion integer GENERATED BY DEFAULT AS IDENTITY,
  estado smallint NOT NULL DEFAULT 1,
  idPersonaCliente integer NOT NULL,
  idPersonaEmpleado integer NOT NULL,
  idVehiculo integer DEFAULT NULL
);
...
CREATE TABLE permiso (
  idPermiso integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE producto (
  ...
  precio numeric(6,2) NOT NULL,
  precioPorMayor numeric(6,2) DEFAULT NULL
);
...
CREATE TABLE proveedor (
  ...
  razonComercial varchar(150) NOT NULL,
  idPersona integer NOT NULL
);
...
CREATE TABLE repuesto (
  idRepuesto integer GENERATED BY DEFAULT AS IDENTITY,
  idProducto integer NOT NULL
);
...
CREATE TABLE tipocliente (
  idTipoCliente integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE tipocomprobanteventa (
  idTipoComprobanteVenta integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE tipodocumento (
  idTipoDocumento integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE tiposervicio (
  idTipoServicio integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE vehiculo (
  idVehiculo integer GENERATED BY DEFAULT AS IDENTITY,
...
--
ALTER TABLE comprobantecompra ADD PRIMARY KEY (idComprobanteCompra);
--
-- Indices de la tabla `comprobanteventa`
--
ALTER TABLE comprobanteventa ADD PRIMARY KEY (idComprobanteVenta);
--
-- Indices de la tabla `detallecompra`
--
ALTER TABLE detallecompra ADD PRIMARY KEY (idDetalleCompra);
--
-- Indices de la tabla `detalleoperacion`
--
ALTER TABLE detalleoperacion ADD PRIMARY KEY (idDetalleOperacion);
--
-- Indices de la tabla `detallepermiso`
--
ALTER TABLE detallepermiso ADD PRIMARY KEY (idDetallePermiso);
--
...
--
ALTER TABLE kardex ADD PRIMARY KEY (idKardex);
--
-- Indices de la tabla `login`
--
ALTER TABLE login ADD PRIMARY KEY (idLogin);
--
-- Indices de la tabla `operacion`
--
ALTER TABLE operacion ADD PRIMARY KEY (idOperacion);
--
-- Indices de la tabla `permiso`
--
ALTER TABLE permiso ADD PRIMARY KEY (idPermiso);
--
...
--
ALTER TABLE repuesto ADD PRIMARY KEY (idRepuesto);
--
...
--
ALTER TABLE tipocomprobanteventa ADD PRIMARY KEY (idTipoComprobanteVenta);
--
...
--
ALTER TABLE tiposervicio ADD PRIMARY KEY (idTipoServicio);
--
...
--
ALTER TABLE cliente ADD CONSTRAINT fk_persona_cliente FOREIGN KEY (idPersona) REFERENCES persona (idPersona);
ALTER TABLE cliente ADD CONSTRAINT fk_tipocliente_cliente FOREIGN KEY (idTipoCliente) REFERENCES tipocliente (idTipoCliente);
--
-- Filtros para la tabla `comprobantecompra`
--
ALTER TABLE comprobantecompra ADD CONSTRAINT fk_proveedor_comprobantecompra FOREIGN KEY (idProveedor) REFERENCES proveedor (idProveedor);
--
-- Filtros para la tabla `comprobanteventa`
--
ALTER TABLE comprobanteventa ADD CONSTRAINT fk_tipocomprovanteventa_comprobanteventa FOREIGN KEY (idTipoComprobanteVenta) REFERENCES tipocomprobanteventa (idTipoComprobanteVenta);
--
-- Filtros para la tabla `detallecompra`
--
ALTER TABLE detallecompra ADD CONSTRAINT fk_comprobantecompra_detallecompra FOREIGN KEY (idComprobanteCompra) REFERENCES comprobantecompra (idComprobanteCompra);
ALTER TABLE detallecompra ADD CONSTRAINT fk_repuesto_detallecompra FOREIGN KEY (idRepuesto) REFERENCES repuesto (idRepuesto);
--
-- Filtros para la tabla `detalleoperacion`
--
ALTER TABLE detalleoperacion ADD CONSTRAINT fk_operacion_detalleoperacion FOREIGN KEY (idOperacion) REFERENCES operacion (idOperacion);
ALTER TABLE detalleoperacion ADD CONSTRAINT fk_producto_detalleoperacion FOREIGN KEY (idProducto) REFERENCES producto (idProducto);
--
-- Filtros para la tabla `detallepermiso`
--
ALTER TABLE detallepermiso ADD CONSTRAINT fk_login_detallepermiso FOREIGN KEY (idLogin) REFERENCES login (idLogin);
ALTER TABLE detallepermiso ADD CONSTRAINT fk_permiso_detallepermiso FOREIGN KEY (idPermiso) REFERENCES permiso (idPermiso);
--
-- Filtros para la tabla `detalleventa`
--
ALTER TABLE detalleventa ADD CONSTRAINT fk_comprobanteventa_detalleventa FOREIGN KEY (idComprobanteVenta) REFERENCES comprobanteventa (idComprobanteVenta);
ALTER TABLE detalleventa ADD CONSTRAINT fk_detalleoperacion_detalleventa FOREIGN KEY (idDetalleOperacion) REFERENCES detalleoperacion (idDetalleOperacion);
--
-- Filtros para la tabla `empleado`
--
ALTER TABLE empleado ADD CONSTRAINT fk_persona_empleado FOREIGN KEY (idPersona) REFERENCES persona (idPersona);
ALTER TABLE empleado ADD CONSTRAINT fk_tipoempleado_empleado FOREIGN KEY (idTipoEmpleado) REFERENCES tipoempleado (idTipoEmpleado);
--
-- Filtros para la tabla `kardex`
--
ALTER TABLE kardex ADD CONSTRAINT fk_repuesto_kardex FOREIGN KEY (idRepuesto) REFERENCES repuesto (idRepuesto);
--
-- Filtros para la tabla `login`
--
ALTER TABLE login ADD CONSTRAINT fk_persona_login FOREIGN KEY (idPersona) REFERENCES persona (idPersona);
--
-- Filtros para la tabla `operacion`
--
ALTER TABLE operacion ADD CONSTRAINT fk_personacliente_operacion FOREIGN KEY (idPersonaCliente) REFERENCES persona (idPersona);
ALTER TABLE operacion ADD CONSTRAINT fk_personaempleado_operacion FOREIGN KEY (idPersonaEmpleado) REFERENCES persona (idPersona);
ALTER TABLE operacion ADD CONSTRAINT fk_vehiculo_operacion FOREIGN KEY (idVehiculo) REFERENCES vehiculo (idVehiculo);
--
-- Filtros para la tabla `persona`
--
ALTER TABLE persona ADD CONSTRAINT fk_tipodocumento_persona FOREIGN KEY (idTipoDocumento) REFERENCES tipodocumento (idTipoDocumento);
--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE proveedor ADD CONSTRAINT fk_persona_proveedor FOREIGN KEY (idPersona) REFERENCES persona (idPersona);
--
-- Filtros para la tabla `repuesto`
--
ALTER TABLE repuesto ADD CONSTRAINT fk_producto_repuesto FOREIGN KEY (idProducto) REFERENCES producto (idProducto);
--
-- Filtros para la tabla `servicio`
--
ALTER TABLE servicio ADD CONSTRAINT fk_t_producto_servicio FOREIGN KEY (idProducto) REFERENCES producto (idProducto);
ALTER TABLE servicio ADD CONSTRAINT fk_tiposervicio_servicio FOREIGN KEY (idTipoServicio) REFERENCES tiposervicio (idTipoServicio);
--
-- Filtros para la tabla `vehiculo`
--
ALTER TABLE vehiculo ADD CONSTRAINT fk_cliente_vehiculo FOREIGN KEY (idCliente) REFERENCES cliente (idCliente);


-- =====================================================================
-- Reajuste de secuencias (columnas GENERATED BY DEFAULT AS IDENTITY)
-- para que el próximo INSERT sin id explícito continúe tras el máximo
-- id cargado desde los datos importados.
-- =====================================================================

SELECT setval(pg_get_serial_sequence('cliente', 'idcliente'), COALESCE((SELECT MAX(idCliente) FROM cliente), 1), (SELECT MAX(idCliente) FROM cliente) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('comprobantecompra', 'idcomprobantecompra'), COALESCE((SELECT MAX(idComprobanteCompra) FROM comprobantecompra), 1), (SELECT MAX(idComprobanteCompra) FROM comprobantecompra) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('comprobanteventa', 'idcomprobanteventa'), COALESCE((SELECT MAX(idComprobanteVenta) FROM comprobanteventa), 1), (SELECT MAX(idComprobanteVenta) FROM comprobanteventa) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('detallecompra', 'iddetallecompra'), COALESCE((SELECT MAX(idDetalleCompra) FROM detallecompra), 1), (SELECT MAX(idDetalleCompra) FROM detallecompra) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('detalleoperacion', 'iddetalleoperacion'), COALESCE((SELECT MAX(idDetalleOperacion) FROM detalleoperacion), 1), (SELECT MAX(idDetalleOperacion) FROM detalleoperacion) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('detallepermiso', 'iddetallepermiso'), COALESCE((SELECT MAX(idDetallePermiso) FROM detallepermiso), 1), (SELECT MAX(idDetallePermiso) FROM detallepermiso) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('detalleventa', 'iddetalleventa'), COALESCE((SELECT MAX(idDetalleVenta) FROM detalleventa), 1), (SELECT MAX(idDetalleVenta) FROM detalleventa) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('empleado', 'idempleado'), COALESCE((SELECT MAX(idEmpleado) FROM empleado), 1), (SELECT MAX(idEmpleado) FROM empleado) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('kardex', 'idkardex'), COALESCE((SELECT MAX(idKardex) FROM kardex), 1), (SELECT MAX(idKardex) FROM kardex) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('login', 'idlogin'), COALESCE((SELECT MAX(idLogin) FROM login), 1), (SELECT MAX(idLogin) FROM login) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('operacion', 'idoperacion'), COALESCE((SELECT MAX(idOperacion) FROM operacion), 1), (SELECT MAX(idOperacion) FROM operacion) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('permiso', 'idpermiso'), COALESCE((SELECT MAX(idPermiso) FROM permiso), 1), (SELECT MAX(idPermiso) FROM permiso) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('persona', 'idpersona'), COALESCE((SELECT MAX(idPersona) FROM persona), 1), (SELECT MAX(idPersona) FROM persona) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('producto', 'idproducto'), COALESCE((SELECT MAX(idProducto) FROM producto), 1), (SELECT MAX(idProducto) FROM producto) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('proveedor', 'idproveedor'), COALESCE((SELECT MAX(idProveedor) FROM proveedor), 1), (SELECT MAX(idProveedor) FROM proveedor) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('repuesto', 'idrepuesto'), COALESCE((SELECT MAX(idRepuesto) FROM repuesto), 1), (SELECT MAX(idRepuesto) FROM repuesto) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('servicio', 'idservicio'), COALESCE((SELECT MAX(idServicio) FROM servicio), 1), (SELECT MAX(idServicio) FROM servicio) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('tipocliente', 'idtipocliente'), COALESCE((SELECT MAX(idTipoCliente) FROM tipocliente), 1), (SELECT MAX(idTipoCliente) FROM tipocliente) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('tipocomprobanteventa', 'idtipocomprobanteventa'), COALESCE((SELECT MAX(idTipoComprobanteVenta) FROM tipocomprobanteventa), 1), (SELECT MAX(idTipoComprobanteVenta) FROM tipocomprobanteventa) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('tipodocumento', 'idtipodocumento'), COALESCE((SELECT MAX(idTipoDocumento) FROM tipodocumento), 1), (SELECT MAX(idTipoDocumento) FROM tipodocumento) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('tiposervicio', 'idtiposervicio'), COALESCE((SELECT MAX(idTipoServicio) FROM tiposervicio), 1), (SELECT MAX(idTipoServicio) FROM tiposervicio) IS NOT NULL);
SELECT setval(pg_get_serial_sequence('vehiculo', 'idvehiculo'), COALESCE((SELECT MAX(idVehiculo) FROM vehiculo), 1), (SELECT MAX(idVehiculo) FROM vehiculo) IS NOT NULL);
